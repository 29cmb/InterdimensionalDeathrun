...
namespace TarodevController
{
    ...
    public class testPlayerController : MonoBehaviour, IPlayerController
    {
        ...
        Vector3 cameraPos;
        [Header("Custom Config (by me)")]
        public bool DisableCustomEvents;
        ...
        public void JumpButton()
        {
            ...
            CalculateJumpButtonJump(); // Possibly overrides vertical
        ...
        private void CalculateJumpButtonJump()
        {
        ...
        private int _freeColliderIterations = 15;
        ...
        private void MoveCharacter()
        {
            ...
            if (!hit)
            {
                mainCamera.transform.position = new Vector3(this.transform.position.x + 5, this.transform.position.y + 2, cameraPos.z);
